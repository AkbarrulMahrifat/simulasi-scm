...
<div class="bg-petunjuk1">
    ...
    <button class="btn btn-info button-back" type="button" onclick="window.location.href='<?=site_url('Simulasi/petunjuk2')?>'"><i class="material-icons next">chevron_right</i></button>
</div>
